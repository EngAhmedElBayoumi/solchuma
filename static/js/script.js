(function($) {
    ...
    // singlebrochour Item Carousel 
	if ($('.singlebrochour-item-carousel').length) {
		$('.singlebrochour-item-carousel').owlCarousel({
			loop:false,
			margin:0,
			nav:true,
			smartSpeed: 500,
	...
	if ($('.Project-item-carousel').length) {
		$('.Project-item-carousel').owlCarousel({
      	...
      	// Single Item Carousel 
	if ($('.Event-item-carousel').length) {
		$('.Event-item-carousel').owlCarousel({
			loop:true,
			margin:0,
			nav:true,
			smartSpeed: 500,
